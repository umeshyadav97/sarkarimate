...
export function NotificationPanels() {
  return (
    <section className="mx-auto grid max-w-7xl gap-5 px-4 py-5 sm:px-6 lg:grid-cols-3 lg:px-8">
      <NotificationPanel
...
function NotificationPanel({
  ...
  return (
    <Card className="rounded-lg border-slate-200 p-4 shadow-sm">
      ...
      <div className="divide-y divide-slate-100">
        {items.map((item) => (
          ...
          >
            ...
            <div>
              <h3 className="text-sm font-extrabold leading-5 text-[#111827]">{item.title}</h3>
            ...
            <div className="text-right">
              ...
              <p
                className={`mt-1 rounded-md px-2 py-1 text-xs font-extrabold ${
      ...
      <a
        href="#"
        className="mt-3 flex h-11 items-center justify-center gap-2 rounded-md border border-blue-300 text-sm font-extrabold text-[#1D4ED8] hover:bg-blue-50"
      >
        {actionLabel}
