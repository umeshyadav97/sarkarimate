...
export function SyllabusShareCard() {
  return (
    <aside className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
      <h2 className="text-xl font-bold text-[#111827]">Share this page</h2>
      <div className="mt-4 flex flex-wrap gap-3">
        {shareItems.map((item) => (
          <Link
            ...
            className={`grid h-11 w-11 place-items-center rounded-full text-white ${item.className}`}
          >
